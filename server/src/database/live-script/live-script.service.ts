...
@Injectable()
export class LiveScriptService {
  ...
  async update(id: string, body: any) {
    ...
    if (body.viewer_count) updateData.viewer_count = parseInt(body.viewer_count)
    if (body.analysis) updateData.analysis = body.analysis
