...
const ContentCreationPage = () => {
  ...
  if (!authLoading && !isLoggedIn) {
    return (
      <View className="content-creation-page" style={{ minHeight: '100vh', backgroundColor: '#0a0f1a', padding: '20px' }}>
      ...
      <View className="page-header">
        ...
        >
          <View
            ...
            onClick={() => Taro.navigateTo({ url: '/package-content/pages/quick-note/index' })}
          >
          ...
          <View
            style={{ display: 'flex', alignItems: 'center', gap: '4px' }}
            onClick={() => Taro.navigateTo({ url: '/package-content/pages/topic-planning/index' })}
          >
