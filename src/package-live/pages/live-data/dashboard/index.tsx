...
const LiveDashboardPage = () => {
  ...
  const navigateToDetail = (type: 'traffic' | 'interaction' | 'conversion') => {
    const urls = {
      traffic: '/package-live/pages/live-data/traffic/index',
      interaction: '/package-live/pages/live-data/interaction/index',
      conversion: '/package-live/pages/live-data/conversion/index',
    };
    navigateTo({ 
      ...
      <ScrollView className="dashboard-container" scrollY>
        ...
        <View className="quick-actions">
          <View className="actions-row">
            <View className="action-item" onClick={() => navigateTo({ url: '/package-live/pages/live-data/import/index' })}>
              <View className="action-icon primary">
                <Text>+</Text>
              </View>
              <Text className="action-label">导入数据</Text>
            </View>
            <View className="action-item" onClick={() => navigateTo({ url: '/package-live/pages/live-data/list/index' })}>
              <View className="action-icon secondary">
                <Text>📝</Text>
              </View>
              <Text className="action-label">直播记录</Text>
            </View>
            <View className="action-item" onClick={() => navigateTo({ url: '/package-live/pages/live-data/analysis/index' })}>
              <View className="action-icon secondary">
                <Text>⭐</Text>
              </View>
          ...
          <View className="metrics-grid simple">
            <View className="metric-card highlight">
              ...
              <View className={`change ${gmvChange >= 0 ? 'up' : 'down'}`}>
                {gmvChange >= 0 ? <Text>📈</Text> : <Text>📉</Text>}
