      ...
      <ScrollView className="px-4 pb-8" scrollY style={{ height: 'calc(100vh - 100px)' }}>
        ...
        <View className="bg-slate-800 rounded-xl p-4 mb-4">
          ...
          <View className="mb-4">
            ...
            <View className="bg-slate-800 rounded-lg px-3 py-2 flex items-center justify-between">
              <Input
                className="flex-1 text-white text-sm bg-transparent"
        ...
        <View className="bg-slate-800 rounded-xl p-4 mb-4">
          ...
          <View className="mb-4">
            ...
            <Textarea
              className="bg-slate-800 rounded-lg px-3 py-2 text-white text-sm min-h-[80px]"
              placeholder="请输入关店原因"
