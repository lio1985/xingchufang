...
export default function MyTeam() {
  ...
  if (!team) {
    return (
      <View className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
  ...
  return (
    <View className="min-h-screen bg-slate-950">
      {/* Header */}
      <View className="bg-gradient-to-br from-blue-600 to-indigo-700 px-4 py-8">
        <View className="flex items-center justify-between mb-4">
          <View>
            <Text className="block text-sm text-blue-200 mb-1">我的团队</Text>
