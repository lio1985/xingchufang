      ...
      <ScrollView scrollY className="flex-1 px-4 py-4">
        ...
        {results.length === 0 && !loading && keyword === '' && (
          <View className="flex flex-col items-center justify-center py-20">
            ...
            <Text className="block text-sm text-slate-600">输入关键词，发现最新动态</Text>
          </View>
        )}
        ...
        {results.length === 0 && !loading && keyword !== '' && (
          <View className="flex flex-col items-center justify-center py-20">
            ...
            <Text className="block text-sm text-slate-600">试试其他关键词</Text>
          </View>
        )}
                ...
                <View className="flex items-center gap-3 mb-3">
                  ...
                  {item.publishTime && (
                    <View className="flex items-center gap-1">
                      ...
                      <Text className="block text-xs text-slate-500">{formatTime(item.publishTime)}</Text>
                    </View>
                  )}
                </View>
