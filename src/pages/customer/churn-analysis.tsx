                        ...
                        .map(([action, data]) => {
                          ...
                          return (
                            <View key={action} className="flex items-center gap-3">
                              <View className="w-10 h-10 rounded-xl bg-slate-700 flex items-center justify-center">
                ...
                {stats.monthlyTrend.length > 0 ? (
                  <>
                    ...
                    <View className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700">
                      ...
                      <View className="space-y-3">
                        {stats.monthlyTrend.map((month, idx) => (
                          <View key={idx} className="flex items-center justify-between py-2 border-b border-slate-700/50 last:border-0">
                            <View className="flex items-center gap-2">
