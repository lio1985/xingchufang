  ...
  return (
    <View className="min-h-screen bg-slate-900">
      ...
      <View className="bg-slate-800 px-4 py-3 border-b border-slate-700">
        <View className="flex items-center gap-2">
          <View
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-700"
          ...
          <View className="mt-3 space-y-3">
            ...
            <View>
              ...
              <View className="flex flex-wrap gap-2">
                <View
                  className={`px-3 py-1.5 rounded-lg text-sm ${typeFilter === 'all' ? 'bg-blue-500' : 'bg-slate-700'}`}
                  onClick={() => setTypeFilter('all')}
                >
                ...
                {Object.entries(typeConfig).map(([key, config]) => (
                  <View
                    key={key}
                    className={`px-3 py-1.5 rounded-lg text-sm flex items-center gap-1 ${typeFilter === key ? config.color : 'bg-slate-700'}`}
            ...
            <View>
              ...
              <View className="flex flex-wrap gap-2">
                <View
                  className={`px-3 py-1.5 rounded-lg text-sm ${!categoryFilter ? 'bg-emerald-500' : 'bg-slate-700'}`}
                  onClick={() => setCategoryFilter('')}
                >
                ...
                {categories.map((cat) => (
                  <View
                    key={cat}
                    className={`px-3 py-1.5 rounded-lg text-sm ${categoryFilter === cat ? 'bg-emerald-500' : 'bg-slate-700'}`}
          ...
          <View className="bg-slate-800 w-full rounded-t-3xl max-h-[80vh] overflow-y-auto">
            ...
            <View className="p-4 space-y-4">
              ...
              <View>
                ...
                <View className="flex gap-2">
                  {Object.entries(typeConfig).map(([key, config]) => (
                    <View
                      key={key}
                      className={`flex-1 px-3 py-2 rounded-lg text-center ${formType === key ? config.color : 'bg-slate-700'}`}
              ...
              <View>
                ...
                <Input
                  className="w-full bg-slate-700 rounded-xl px-4 py-3 text-white"
                  placeholder="请输入标题"
                  value={formTitle}
              ...
              <View>
                ...
                <Textarea
                  className="w-full bg-slate-700 rounded-xl px-4 py-3 text-white min-h-[200px]"
              ...
              <View>
                ...
                <View className="bg-slate-700 rounded-xl px-4 py-2 flex items-center gap-2 mb-2">
              ...
              <View className="flex gap-3 pt-2">
                <View
                  className="flex-1 bg-slate-700 rounded-xl py-3 text-center"
        ...
        <View className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
          <View className="bg-slate-800 w-full rounded-2xl max-h-[80vh] overflow-y-auto">
            ...
            <View className="p-4 space-y-4">
                ...
                <View>
                  ...
                  <View className="flex flex-wrap gap-2">
                    {selectedLexicon.tags.map((tag, index) => (
                      <View
                        key={index}
                        className="px-3 py-1.5 rounded-lg bg-blue-500/20"
                      >
                        <Text className="text-blue-400 text-sm">{tag}</Text>
                      </View>
                    ))}
              ...
              <View className="text-slate-500 text-xs pt-4 border-t border-slate-700">
