        ...
        <View className="px-4 py-3 space-y-3">
                ...
                <View className="flex-1 min-w-0">
                  ...
                  {log.resourceType && (
                    <View className="flex items-center gap-1">
                      ...
                      <Text className="text-slate-500 text-sm">{log.resourceType}</Text>
                    </View>
                  )}
          ...
          {!loading && logs.length === 0 && (
            <View className="text-center py-12">
              ...
              <Text className="text-slate-500 block">暂无日志数据</Text>
            </View>
          )}

          {!loading && logs.length >= total && logs.length > 0 && (
            <View className="text-center py-4">
              <Text className="text-slate-500">已加载全部数据</Text>
            </View>
          )}
        </View>
          ...
          <View className="w-full bg-slate-800 rounded-t-3xl p-4 max-h-[80vh] overflow-y-auto">
            ...
            <View className="space-y-3">
              ...
              <View className="bg-slate-700 rounded-lg p-4">
                ...
                <View className="mb-2">
                  <Text className="text-slate-500 text-xs block">用户ID</Text>
              ...
              {selectedLog.resourceType && (
                <View className="bg-slate-700 rounded-lg p-4">
                  ...
                  {selectedLog.resourceId && (
                    <View className="mb-2">
                      <Text className="text-slate-500 text-xs block">资源ID</Text>
              ...
              <View className="bg-slate-700 rounded-lg p-4">
                ...
                {selectedLog.userAgent && (
                  <View className="mb-2">
                    <Text className="text-slate-500 text-xs block">User Agent</Text>
