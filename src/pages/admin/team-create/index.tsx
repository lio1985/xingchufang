    ...
    <View className="min-h-screen bg-slate-900">
      ...
      <View className="p-4 space-y-4">
        ...
        <View className="bg-slate-900 rounded-xl p-4 border border-slate-800">
          ...
          <Text className="block text-xs text-slate-400 mt-1 text-right">{description.length}/200</Text>
        </View>
        ...
        <View className="bg-slate-900 rounded-xl p-4 border border-slate-800">
          ...
          <Text className="block text-xs text-slate-400 mt-2">负责人将自动加入团队并拥有管理权限</Text>
        </View>
