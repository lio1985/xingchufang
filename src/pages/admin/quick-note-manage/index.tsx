                ...
                <View className="flex-1 min-w-0">
                  ...
                  {note.userNickname && (
                    <View className="flex items-center gap-1 mb-2">
                      ...
                      <Text className="text-slate-500 text-xs">{note.userNickname}</Text>
                    </View>
                  )}
                  ...
                  <View className="flex items-center justify-between">
                    <View className="flex items-center gap-1">
                      ...
                      <Text className="text-slate-500 text-xs">{formatDate(note.updatedAt)}</Text>
                    </View>
                    {note.tags && note.tags.length > 0 && (
                      <View className="flex items-center gap-1">
                        <Tag size={14} color="#94a3b8" />
                        <Text className="text-slate-500 text-xs">{note.tags.join(', ')}</Text>
                      </View>
                    )}
                  </View>
                </View>
