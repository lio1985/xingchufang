      ...
      <View className="px-4 mt-6 flex flex-col gap-6">
        ...
        {analysis && (
          <View className="bg-slate-800/90 rounded-2xl border border-slate-700/80 p-5">
            ...
            <View className="bg-slate-700/60 rounded-xl p-4 max-h-48 overflow-y-auto">
        ...
        <View className="bg-slate-800/90 rounded-2xl border border-slate-700/80 p-5">
          <View className="flex items-center justify-between mb-4">
            ...
            <View className="flex items-center gap-2">
              ...
              <View
                className="px-3 py-1.5 bg-slate-700 rounded-lg active:scale-95 transition-all"
                onClick={toggleAll}
              >
              ...
              <View className="flex flex-col gap-4 max-h-96 overflow-y-auto">
                ...
                {(() => {
                  ...
                  return enterpriseLexicons.length > 0 && (
                    <View className="bg-slate-700/40 rounded-xl overflow-hidden">
                      <View
                      ...
                      {(expandedCategory === 'all' || expandedCategory === 'enterprise') && (
                        <View className="p-3 flex flex-col gap-2">
                          {enterpriseLexicons.map((lexicon) => (
                            <View
                              key={lexicon.id}
                              className="bg-slate-700/60 rounded-lg p-3 active:bg-slate-700/80 transition-all"
                            >
                ...
                {(() => {
                  ...
                  return personalLexicons.length > 0 && (
                    <View className="bg-slate-700/40 rounded-xl overflow-hidden">
                      <View
                        className="flex items-center justify-between px-4 py-3 bg-blue-500/10 border-b border-blue-500/20 active:bg-blue-500/20 transition-all"
          ...
          <View className="flex flex-col gap-6">
            ...
            {generatedSchemes.map((scheme, idx) => (
              ...
              >
                <View className="flex items-center justify-between mb-4">
                  ...
                  <View
                    className="px-3 py-1.5 bg-blue-500/20 rounded-lg active:scale-95 transition-all"
                  ...
                  <View>
                    ...
                    <View className="flex flex-wrap gap-2">
                      {scheme.tags.map((tag, tagIdx) => (
                        <View key={tagIdx} className="px-3 py-1.5 bg-blue-500/20 rounded-lg">
            ...
            <View
              className={`py-3 rounded-xl text-center transition-all ${
                isGenerating
                  ? 'bg-slate-700 text-slate-400'
                  : 'bg-slate-700/50 text-slate-300 active:scale-[0.98]'
              }`}
