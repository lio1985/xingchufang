        ...
        {script && (
          <View className="px-4 mt-6">
            ...
            <View className="flex items-center gap-2 mb-4">
              <Button
                size="mini"
                className={`flex-1 ${activeTab === '15s' ? 'bg-pink-500/30 text-pink-400 border-pink-500/40' : 'bg-slate-800 text-slate-400 border-slate-700/80'}`}
              ...
              <Button
                size="mini"
                className={`flex-1 ${activeTab === '30s' ? 'bg-pink-500/30 text-pink-400 border-pink-500/40' : 'bg-slate-800 text-slate-400 border-slate-700/80'}`}
              ...
              <Button
                size="mini"
                className={`flex-1 ${activeTab === '60s' ? 'bg-pink-500/30 text-pink-400 border-pink-500/40' : 'bg-slate-800 text-slate-400 border-slate-700/80'}`}
