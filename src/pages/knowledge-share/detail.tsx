      ...
      <ScrollView className="flex-1" scrollY>
        <View className="p-4">
          ...
          <View className="flex items-center gap-3 mb-4">
            <View className="w-10 h-10 bg-slate-700 rounded-full flex items-center justify-center">
          ...
          {/* 分类 */}
          <View className="mb-4">
            <View className="inline-block px-3 py-1 bg-blue-500/20 border border-blue-500/30 rounded-lg">
                  ...
                  >
                    {attachment.fileType === 'image' ? (
                      ...
                      <View className="flex items-center gap-3">
                        <View className="w-12 h-12 rounded-lg bg-blue-500/20 flex items-center justify-center">
                      ...
                      <View className="flex items-center gap-3">
                        <View className="w-12 h-12 rounded-lg bg-slate-700 flex items-center justify-center">
          ...
          <View className="flex items-center justify-center gap-6 py-4 border-t border-slate-700">
            <View
              className={`flex items-center gap-2 px-6 py-3 rounded-xl transition-all ${
                detail.isLiked ? 'bg-pink-500' : 'bg-slate-700'
              }`}
              onClick={handleLike}
            >
