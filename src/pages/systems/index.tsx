    ...
    <View className="flex flex-col gap-4">
      ...
      <View className="bg-slate-800 rounded-xl border border-slate-700 p-4">
          ...
          <View className="mb-4">
            ...
            <View className="flex flex-wrap gap-2">
              {inputSources.platforms.map((platform: string) => (
                <View
                  key={platform}
                  className="bg-slate-9000/20 border border-sky-500/30 px-3 py-1.5 rounded-lg"
                >
            ...
            <View className="flex flex-col gap-2">
              ...
              {inputSources.customQuestions.liveQuestions && inputSources.customQuestions.liveQuestions.length > 0 && (
                <View className="bg-slate-800 rounded-lg p-3">
                  <Text className="block text-xs text-slate-400 mb-2">直播高频问题 ({inputSources.customQuestions.liveQuestions.length})</Text>
              ...
              {inputSources.customQuestions.salesQuestions && inputSources.customQuestions.salesQuestions.length > 0 && (
                <View className="bg-slate-800 rounded-lg p-3">
                  <Text className="block text-xs text-slate-400 mb-2">销售高频问题 ({inputSources.customQuestions.salesQuestions.length})</Text>
              ...
              {inputSources.customQuestions.commentQuestions && inputSources.customQuestions.commentQuestions.length > 0 && (
                <View className="bg-slate-800 rounded-lg p-3">
                  <Text className="block text-xs text-slate-400 mb-2">私信评论问题 ({inputSources.customQuestions.commentQuestions.length})</Text>
        ...
        {!inputSources || (
          ...
          <View className="bg-slate-800/30 rounded-lg p-4 text-center">
            <Text className="block text-sm text-slate-400 mb-2">尚未配置输入来源</Text>
            <View
              className="inline-block px-4 py-2 bg-slate-9000/20 border border-sky-500/30 rounded-lg active:scale-95 transition-all"
              onClick={() => Taro.navigateTo({ url: '/pages/input-sources/index' })}
            >
    ...
    <View className="flex flex-col gap-4">
      ...
      <View className="bg-slate-800 rounded-xl border border-slate-700 p-4">
        ...
        <View className="grid grid-cols-2 gap-2">
          ...
          <View className="bg-slate-800 rounded-lg p-3 text-center col-span-2">
      ...
      <View className="bg-slate-800 rounded-xl border border-slate-700 p-4">
        ...
        <View className="flex flex-col gap-2">
          <View className="flex items-center gap-3 py-2 bg-slate-800 rounded-lg px-3">
  ...
  const renderViralSystem = () => (
    <View className="flex flex-col gap-4">
      ...
      <View className="bg-slate-800 rounded-xl border border-slate-700 p-4">
        ...
        <View className="flex flex-col gap-2">
          <View className="flex items-center gap-2 py-2 bg-slate-800 rounded-lg px-3">
