  ...
  const quickActions: QuickAction[] = [
    {
      ...
      path: '/package-team/pages/team/announcement',
    },
    {
      id: 'tasks',
      icon: ClipboardList,
      ...
      path: '/package-team/pages/team/task',
    },
    {
      id: 'target',
      icon: Target,
      ...
      path: '/package-customer/pages/customer/sales-target',
    },
    {
      id: 'members',
      icon: Users,
    ...
    },
    {
      ...
      path: '/package-user/pages/data-stats/index',
    },
    {
      id: 'chat',
      icon: MessageCircle,
